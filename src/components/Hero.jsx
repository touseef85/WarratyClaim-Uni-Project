  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row items-center lg:gap-10 secondary-font relative">
      ...
      >
        ...
        Warranty Claim Made Easy
        </h1>
        <p className="text-xl mt-5 text-gray-600 primary-font">
        At [Your Company Name], we make it easy to submit and track your warranty claims. Whether it's a malfunction, damage, or defect, our streamlined platform ensures quick resolution and support. Start your claim today and get the help you need!
        </p>
